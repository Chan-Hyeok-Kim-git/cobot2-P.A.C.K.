...
class VoiceCommandNode(Node):
    ...
    def announce_completion(self):
        try:
            ...
            scripts = {
                "지진": "지진 대비 비상 물품 준비가 완료되었습니다. 헬멧을 우선 착용하시고 가방을 챙겨 대피하세요.",
                "홍수": "홍수 대비 비상 물품 준비가 완료되었습니다. 우비를 우선 입으시고 장화를 신으신 후 안전한 장소로 대피하세요.",
                "화재": "화재 대비 비상 물품 준비가 완료되었습니다. 마스크를 반드시 착용하시고 안전한 장소로 대피하세요.",
                "공습": "공습 대비 비상 물품 준비가 완료되었습니다. 안내에 따라 방공호로 대피하세요.",
            }
